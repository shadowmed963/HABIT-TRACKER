import { KeyRound, LogIn, ShieldCheck, UserRound, UserRoundPlus } from "lucide-react";
...
export default function AuthPanel({ hasExistingUsers, onSubmit }: AuthPanelProps) {
  ...
  return (
    <section className="overflow-hidden rounded-[32px] border border-border/70 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.96),rgba(240,237,255,0.94)_42%,rgba(216,250,237,0.78)_100%)] dark:bg-[radial-gradient(circle_at_top_left,rgba(40,35,70,0.9),rgba(35,30,60,0.85)_42%,rgba(30,25,55,0.8)_100%)] p-5 shadow-[0_32px_90px_rgba(77,73,122,0.18)] ring-1 ring-ring/60 sm:p-7">
        ...
        >
          ...
          <form className="mt-6" onSubmit={handleSubmit}>
            ...
            >
              ...
              <span className="inline-block">{mode === "login" ? t.auth.loginButton : t.auth.createAccountButton}</span>
            </button>
          </form>
